    ...
    <LoadingOverlay>
      ...
      > */}
        <Integration
          ...
          logo={window.location.origin + "/assets/images/magicbricks.png"}
        />
        <div className="px-3 py-2">
          <div>
          Connect your Magicbricks account to 3sigma and run your workflows with 3000+ apps 
          </div>
          <div className="mt-4">How does Magicbricks integration work?</div>
          ...
          <img src={window.location.origin + "/assets/images/magicbricks.png"} />
            &nbsp;Connect Magicbricks</div>
        </div>
      {/* </BottomSheet> */}
    </LoadingOverlay>
  );
