...
function GoogleAds(props) {
  ...
  const onSubmit = (e) => {
    ...
    let body ={
      integrationKey: "google_lead_form",
    ...
    <LoadingOverlay>
      ...
      > */}
        ...
        <div className="px-3 py-2">
          <div>
          Connect your Google Ads leadforms  and automatically import your form submissions instantly .          </div>
          <div className="mt-4">How does Google Ads leadsforms work?</div>
          ...
          <div className="mt-4  ">Webhook URL</div>
          ...
          <div className="mt-1  ">API key</div>
          <div style={copyIcon}>
...
<img src={window.location.origin + "/assets/images/GoogleAds.png"} />

</span>
            &nbsp;Connect Google  leadform</div>
        </div>
      {/* </BottomSheet> */}
    </LoadingOverlay>
  );
